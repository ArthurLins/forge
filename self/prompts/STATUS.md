...
## Phase S2 — Scale & async-collaboration readiness (3/8)
...
| [v] | S2.4 | Claim lifecycle hardening: heartbeat/TTL + retry count + auto-release of dead claims + auto-blocked after N failures | S2.1 | functional, decisions | — |
