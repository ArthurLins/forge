...
## Phase S2 — Scale & async-collaboration readiness (2/8)
...
| [v] | S2.2 | Prompt context discipline: just-in-time @requirement retrieval + load-bearing instructions at start/end + worked examples (context budget) | S2.1 | functional, decisions | — |
